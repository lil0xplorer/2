			...
			<Layout>
				<Head>
					...
					<meta
						name="description"
						content={
							publication.descriptionSEO || publication.title || `${publication.author.name}'s Blog` || 'A Hashnode-powered blog.'
						}
					/>
					<meta
						name="keywords"
						content={'blog, hashnode, tech, programming, software, development'}
					/>
				...
				<Header isHome={true} />
				<div>
					{/* Add H1 for SEO, only on homepage, outside of header for clarity */}
					<h1 className="sr-only">{publication.displayTitle || publication.title || 'Hashnode Blog Starter Kit'}</h1>
